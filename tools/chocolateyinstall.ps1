...
[version] $softwareVersion = '4.5.2309.2502'
...
if ($currentVersion -and $currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m51/4.5.2309.2502/XSplit_Broadcaster_4.5.2309.2502.exe'
    checksum64     = '96a51e506d009afe99fa733f70f7f9b59f22b60844b0944bcd7d772fac6ebda8'
