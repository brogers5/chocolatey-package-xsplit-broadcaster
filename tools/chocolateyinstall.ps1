...
[version] $softwareVersion = '4.5.2310.301'
...
if ($currentVersion -and $currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m51/4.5.2310.0301/XSplit_Broadcaster_4.5.2310.0301.exe'
    checksum64     = 'ab4c48673a3e62db3aa294ed9ab307a9a6226c41cb66cb0415a2fa482de83a2c'
