...
[version] $softwareVersion = '4.5.2311.2110'
...
if ($currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m51/4.5.2311.2110/XSplit_Broadcaster_4.5.2311.2110.exe'
    checksum64     = '8c2b26d37a82bce3bc0a75e4a15aeba585833cd02703eb6d6c5d665e04aa7573'
