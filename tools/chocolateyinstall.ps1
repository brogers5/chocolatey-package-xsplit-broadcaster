...
else
{
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m48/4.4.2208.1904/XSplit_Broadcaster_4.4.2208.1904.exe'
    checksum64     = '3044a97dfa1775f1d797b153fcadb27f4e31ea24c7502f2b8ffc3536f6b83457'
