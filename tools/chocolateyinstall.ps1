...
[version] $softwareVersion = '4.5.2403.401'
...
if ($currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m53/4.5.2403.0401/XSplit_Broadcaster_4.5.2403.0401.exe'
    checksum64     = 'f1a36fac3eed7c431fe6a32146ee79f00a2a8b06aed4ace11b70377cbaecaf86'
