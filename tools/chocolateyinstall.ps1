...
else
{
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m48/4.4.2207.2704/XSplit_Broadcaster_4.4.2207.2704.exe'
    checksum64     = '87057da1eb8e26b29dfe8f5d4d382f6089c074cee2a45f2d04d1e7af5ee17d62'
