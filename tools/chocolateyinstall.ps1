...
[version] $softwareVersion = '4.5.2406.1808'
...
if ($currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m54/4.5.2406.1808/XSplit_Broadcaster_4.5.2406.1808.exe'
    checksum64     = '0def76059ab39d3e1afe8d01808634940bb62903dc3b7d3221e015c80a9b80d0'
