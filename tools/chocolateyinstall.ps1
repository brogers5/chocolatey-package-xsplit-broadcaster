...
else
{
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn2.xsplit.com/download/bc/m50/4.4.2304.1201/XSplit_Broadcaster_4.4.2304.1201.exe'
    checksum64     = 'ac34504a1e51f1429a5bcdbca23e3c919e17b159e0f5c5b5ef8231cf3d9fba3a'
