...
[version] $softwareVersion = '4.6.2609.2101'
...
if ($currentVersion -eq $softwareVersion -and !$env:ChocolateyForce) {
  ...
  $packageArgs = @{
    ...
    fileType       = 'EXE'
    url64bit       = 'https://cdn.xsplit.com/download/bc/beta/4.6.2609.2101/XSplit_Broadcaster_4.6.2609.2101-xsolla.exe'
    checksum64     = 'c6fef56ee2e6ac068d85b7c0624b6616f65d184756518fe4d51d9a90ebac155b'
